...
export default async function CoTeacherRosterPage({
    params,
}: {
    ...
    // Check if user is Co-Teacher for this course
        ...
        <div className="space-y-4 p-6">
            <div className="flex items-end justify-between gap-3">
                ...
                <div className="flex gap-2">
                    <Link
                        href={`/coteacher/courses/${id}/attendance`}
            ...
            <div className="p-4 bg-purple-500/10 border border-purple-500/30 rounded text-purple-200 text-sm">
                📖 <strong>View Only:</strong> As a Co-Teacher, you can view the roster but cannot import or manage team members.
            </div>
